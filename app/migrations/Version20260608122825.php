 ...
 */
final class Version20260608122825 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE note ADD created_at DATETIME NOT NULL, ADD owner_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE note DROP created_at, DROP owner_id');
    }
}
